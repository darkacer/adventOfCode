...
function getCharAndValue(chars : string):any {
    let arr = chars.split('')
    return {
        char: arr.shift(),
...
function updateDirection(currentDirection: number, update: string) : number {
    console.log(currentDirection, 'update', update);
    ...
    console.log('direction updated ', currentDirection);
...
while(i < inputArr.length) {
    //let {char, value} = getCharAndValue(inputArr[i]);
